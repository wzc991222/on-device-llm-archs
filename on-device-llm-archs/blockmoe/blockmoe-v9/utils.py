...
def grouped_gemm_forward(
    ...
    if block.shape[1] == config.p_layer_expert_num:
        repeat_num = config.p_expert_num_per_token
    if block.shape[1] == config.f_layer_expert_num:
        repeat_num = config.f_expert_num_per_token
