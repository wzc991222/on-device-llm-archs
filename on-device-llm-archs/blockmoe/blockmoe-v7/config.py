...
class Config:
    ...
    aux_dim: int
    aux_attn_num: int
    aux_token_layer_num: int
    aux_block_layer_num: int
    aux_token_mask_type: int
    aux_block_mask_type: int
    aux_predict_model: bool
    aux_p_token_layer_num: int
    aux_p_block_layer_num: int
    aux_p_token_mask_type: int
    aux_p_block_mask_type: int
    routed_expert_num: int
    expert_num_per_token: int
    router_group_num: int
    router_predict_loss_factor: float
    main_balance_loss: bool
    balance_loss_factor: float
    main_balance_loss_coeff: float
