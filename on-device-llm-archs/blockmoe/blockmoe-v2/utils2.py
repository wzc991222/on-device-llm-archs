    ...
    def backward(ctx, grad_output: torch.Tensor):
        ...
        if for_loop_option:
            if grad_block_option:
                ...
                grad_block_3 = [
                    y1 @ y2 for y1, y2 in zip(grad_y_st, y_s3) if y2.shape[0] != 0
                ]
        ...
        if for_loop_option:
            ...
            if grad_block_option:
                grad_block_1 = [
                    x @ y for x, y in zip(x_st, grad_y_s1) if x.shape[1] != 0
                ]
                grad_block_2 = [
                    x @ y for x, y in zip(x_st, grad_y_s2) if x.shape[1] != 0
                ]
        ...
        if grad_block_option:
            ...
            if for_loop_option:
                ...
                index_freq_mask = torch.tensor(index_freq) > 0
