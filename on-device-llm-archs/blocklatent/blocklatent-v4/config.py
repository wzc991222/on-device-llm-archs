...
class Config:
    ...
    train_mode: str  # "pre", "main"
    latent_loss_type: str  # "cross_entropy", "mse"
    main_mode_init: bool
    encoder_mask: bool
    main_encoder_mask: bool
    mask_rate: float
    latent_vq: bool
    vq_rate: float
    vq_st: bool
    unmask_factor: float
    sole_latent_vocab: bool
    copy_latent_vocab: bool
    latent_loss: bool
    codebook_loss: bool
    orthog_loss: bool
    latent_loss_factor: float
    codebook_loss_type: str  # "cross_entropy", "mse"
    codebook_loss_factor: float
    codebook_threshold: float
    codebook_label_prob_mode: bool
    codebook_label_prob_norm: bool
    ...
    parallel_factor: float = field(init=False)
